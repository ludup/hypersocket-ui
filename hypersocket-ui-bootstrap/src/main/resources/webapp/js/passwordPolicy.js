...
$.fn.passwordPolicy = function(data) {
	...
	if(options.passwordElement) {
		...
		if(options.alternativeUi) {
            ...
            var ig = $('<span class="input-group-text gap-3"><span><a id="regeneratePassword" href="#" class="me-1"><i class="far fa-refresh"></i></a></span><span><a id="copyPassword" class="copyPassword" href="javascript:"><i class="far fa-copy"></i></a></span></span>'); 
			parent.append(ig);
        }
	}
