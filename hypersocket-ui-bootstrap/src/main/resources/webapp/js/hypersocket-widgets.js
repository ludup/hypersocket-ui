...
$.fn.fileTree = function(data) {
	...
	if ($(this).data('created')) {
		...
		$('#' + id).append(
				...
				+	'		<button id="' + id + 'Include" class="btn btn-small btn-primary"><i class="fa fa-chevron-right"></i></button>'
				+	'		<button id="' + id + 'IncludeAll" class="btn btn-small btn-primary"><i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></button>'
				+	'		<button id="' + id + 'Exclude" class="btn btn-small btn-primary"><i class="fa fa-chevron-left"></i></button>'
				+	'		<button id="' + id + 'ExcludeAll" class="btn btn-small btn-primary"><i class="fa fa-chevron-left"></i><i class="fa fa-chevron-left"></i></button>'
				+	'	</div>'
